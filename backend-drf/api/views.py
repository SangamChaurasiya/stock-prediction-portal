...
class StockPredictionAPIView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            # fetch the data from yfinance(Yahoo Finance)
            now = datetime.now()
            ...
            plot_100_dma_path = f'{ticker}_100_dma.png'
            plot_100_dma = save_plot(plot_100_dma_path)
            ...
            plot_200_dma_path = f'{ticker}_200_dma.png'
            plot_200_dma = save_plot(plot_200_dma_path)
            ...
            plot_final_path = f'{ticker}_final_prediction.png'
            plot_prediction = save_plot(plot_final_path)
